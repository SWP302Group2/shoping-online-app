...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        String errMess = "Wrong user name or password!";
        String email ;
        String password;
        HttpServletRequest wrapRequest = (HttpServletRequest) request;
        HttpServletResponse wrapResponse = (HttpServletResponse) response;
        password = wrapRequest.getParameter("txtPass");    
        email = wrapRequest.getParameter("txtEmail");
        if(wrapRequest.getSession(false) != null && wrapRequest.getSession(false).getAttribute("CURRENT_USER_USERID") != null){
            ...
            if (email.equals("") || password.equals("") || Method.checkEmail(email) == false || Method.checkPassword(password) == false) { //include login.jsp and display error mess without connect db
                RequestDispatcher dispatch = wrapRequest.getRequestDispatcher(LOGIN_PAGE);
                request.setAttribute("ERROR_MESSAGE", errMess);
                dispatch.forward(request, response);
            } else { //call LoginServlet
