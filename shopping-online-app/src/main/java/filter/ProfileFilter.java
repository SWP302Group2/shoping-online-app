...
public class ProfileFilter implements Filter {
 private static final org.apache.logging.log4j.Logger logger = LogManager.getLogger(ProfileFilter.class);
     ...
     */
    private final String PROFILE_PAGE = "profileJSP";
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (btAction != null) {
            if (btAction.equals("update")) { //call profile servlet
                chain.doFilter(request, response);
            } else if(btAction.equals("Apply")){
                url = UPDATE_PROFILE; //forward to updateProfileServlet
                RequestDispatcher dispatch = wrapRequest.getRequestDispatcher(url);
